  ...
  return (
    <div className="max-w-6xl mx-auto space-y-6">
      ...
      <div className="card bg-gradient-to-r from-emerald-600 to-emerald-700 text-white border-0">
        <p className="text-emerald-100 text-sm font-medium">Patrimoine total</p>
        <p className="text-4xl font-bold mt-1">{fmt(totalGlobal)}</p>
        <p className="text-emerald-200 text-sm mt-1">{comptes.length} comptes suivis</p>
      </div>
